...
public class DifficultyRecipes {
    ...
    private void addDebugRecipes() {
        ShapedDifficultyRecipe.builder()
            .addRecipe(
                Difficulty.PEACEFUL,
                new ShapedOreRecipe(new ItemStack(Items.snowball), "x ", " x", 'x', Blocks.pumpkin))
        ...
        ShapedDifficultyRecipe.builder()
            .addRecipe(
                Difficulty.EASY,
                new ShapedOreRecipe(new ItemStack(Items.snowball), "x ", " x", 'x', Blocks.stone))
        ...
        ShapedDifficultyRecipe.builder()
            .addRecipe(
                Difficulty.EASY,
                new ShapedOreRecipe(new ItemStack(Items.snowball), "x ", " x", 'x', Items.diamond))
